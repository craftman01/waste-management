...
{/* ................................................................................................................ */}
    ...
    {/* <p className='text-gray-400 my-3'>or use your email account</p> */}
         ...
         <div className='flex flex-col items-center '>
             ...
             <input onChange={(e) => setEmail(e.target.value)} className='mx-2 outline-none bg-gray-100 text-sm flex-1' type="email" name="email" placeholder='Email'></input>
             </div>

                <div className=' bg-gray-100 w-64 p-2 flex items-center mb-3'>
                 <FaLock className='text-gray-400 m-2 '/>
                  <input onChange={(e) => setPassword(e.target.value)} className='mx-2 outline-none bg-gray-100 text-sm flex-1' type="password" name="password" placeholder='Password'></input>
                 </div>

                 {/* <div className=' bg-gray-100 w-64 p-2 flex items-center mb-3'>
                 <FaLock className='text-gray-400 m-2 '/>
                  <input className='mx-2 outline-none bg-gray-100 text-sm flex-1' type="password" name="passwordConfirmation" placeholder='Password Confirmation'></input>
                 </div> */}
              ...
              <div className='w-2/3 bg-green-600 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12'> 
                  <h1 className=' text-3xl font-bold mb-2'>Hello, Friends!</h1>
                    <div className="border-2 w-10 border-white inline-block mb-2"></div>
                     <p className='mb-10'> Alredy have an account!</p>
